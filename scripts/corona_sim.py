...
age, agegroup, gender, contacts, drate, hnr, persons = cl.read_campus(
    "../data/population_campus.csv", 1000000)

state, statesum, infections, day0, rnow, args = cl.sim(
    age, drate, nday=730, cutdown=2000, prob_icu=0.01125, day0icu=200,
    ...
    com_attack_rate=0.8, contacts=contacts, r_mean=2.0, cutr_mean=1.05,
    simname="Basisszenario")
